...
class TestPointMaskPanopticHead(unittest.TestCase):
    def setUp(self):
        self.batch_size = 2
        sizes_w = [35, 18, 9, 5]
        sizes_h = [40, 20, 10, 5]
        ...
        self.backbone_out = [torch.randn((self.batch_size, dims[i], sizes_w[i], sizes_h[i])) for i in range(4)]
    ...
    def test_panoptic_head(self):
        ...
        for c, m in zip(cls, masks):
            ...
            self.assertEqual((self.batch_size, self.num_queries, 35, 40), m.shape)
